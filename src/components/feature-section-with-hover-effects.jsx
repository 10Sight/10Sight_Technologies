...
export function FeaturesSectionWithHoverEffects({ data }) {
  if (!data?.features?.length) return null; // Safety check if no data

  return (
    <div className=" bg-white grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 relative z-10 py-10 max-w-7xl mx-auto">
